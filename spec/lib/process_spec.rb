...
describe ProcessManager::Process do
  ...
  it "is kanban compatible for a connected process" do
    ...
    step_1 = Fabricate(:process_step, process_id: process.id, position: 1)
    step_2 = Fabricate(:process_step, process_id: process.id, position: 2)
  ...
  it "is not kanban compatible when steps are disconnected from start" do
    ...
    Fabricate(:process_step, process_id: process.id, position: 1)
    Fabricate(:process_step, process_id: process.id, position: 2)
